...
object BukkitClassLoader {
    ...
    fun <T> load(classType: Class<T>, prefix: String, version: String): T {
        ...
        return try {
            ...
            (getMatchingAccessibleConstructor(
                (nmsClass?: throw ClassNotFoundException("Not found class: $candidates")), null)?: throw UnsupportedOperationException("${classType.name} does not have constructor.]"
            )).newInstance()
